...
export const SCHOLARSHIP_SOURCES: readonly ScholarshipSource[] = [
  ...
  { domain: "fafsa.gov", name: "FAFSA Federal Aid", tags: ["general"] },
  { domain: "studentaid.gov", name: "Federal Student Aid", tags: ["general"] },
  { domain: "scholarshipexpress.com", name: "Scholarship Express", tags: ["general"] },
  { domain: "kroger.com", name: "Kroger Foundation", tags: ["general"] },
  { domain: "aflac.com", name: "Aflac Scholarships", tags: ["general"] },
  { domain: "burgerkingfoundation.org", name: "Burger King Scholars", tags: ["general"] },
  { domain: "mcdonalds.com", name: "McDonald's Education Fund", tags: ["general"] },
  { domain: "tacobellfoundation.org", name: "Taco Bell Foundation", tags: ["general"] },
  { domain: "walmart.org", name: "Walmart Foundation", tags: ["general"] },
  { domain: "target.com", name: "Target Community Scholarships", tags: ["general"] },
  ...
  // Student aid & material support
  { domain: "computers4people.org", name: "Computers 4 People", tags: ["general", "laptops", "technology"] },
  { domain: "pcsforpeople.org", name: "PCs for People", tags: ["general", "laptops", "technology"] },
  { domain: "human-i-t.org", name: "Human-I-T (Low-Cost Tech)", tags: ["general", "laptops", "technology"] },
  { domain: "computerswithcauses.org", name: "Computers with Causes", tags: ["general", "laptops", "technology"] },
  { domain: "freecycle.org", name: "Freecycle (Free Items)", tags: ["general", "laptops", "furniture"] },
  { domain: "everyoneon.org", name: "EveryoneOn (Low-Cost Internet)", tags: ["general", "internet"] },
  { domain: "openstax.org", name: "OpenStax Free Textbooks", tags: ["general", "textbooks"] },
  { domain: "openlibrary.org", name: "Open Library", tags: ["general", "textbooks"] },
  { domain: "chegg.com", name: "Chegg (Textbook Rentals)", tags: ["general", "textbooks"] },
  ...
  { domain: "emergencyaidforstudents.org", name: "Emergency Aid for Students", tags: ["general", "emergency"] },
  { domain: "collegesuccessfoundation.org", name: "College Success Foundation", tags: ["general", "emergency"] },
  { domain: "studentemergency.org", name: "Student Emergency Assistance", tags: ["general", "emergency"] },
  ...
  { domain: "onedegree.org", name: "One Degree (Student Resources)", tags: ["general", "resources"] },
  { domain: "benefits.gov", name: "Gov Benefits (Student Aid)", tags: ["general", "resources"] },
  { domain: "needhelppayingbills.com", name: "Need Help Paying Bills", tags: ["general", "utilities"] },
  { domain: "211.org", name: "211 Helpline (Essential Needs)", tags: ["general", "resources", "emergency"] },
  { domain: "modestneeds.org", name: "Modest Needs (Emergency Grants)", tags: ["general", "emergency"] },
